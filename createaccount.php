...
<label for="birthday">Birthday:</label>
  <input type="date" id="birthday" name="birthday" required>
                ...
                <label for="Phone">Phone Number:</label>
                 <input type="tel" name="Phone" id="Phone" placeholder="12-345-678" pattern="[0-9]{2}-[0-9]{3}-[0-9]{3}" required>  
                 </div> 
                 <div class="col-md-6 form-group">
                <label for="Username">Username:</label>
                 <input type="text"  class="form-control" name="Username" id="Username" placeholder="username" required>
                  ...
                  <div class="col-md-6 form-group">
                   ...
                   <input type="text"  class="form-control" name="Email" id="eamil" placeholder="something@gmail.com" required>  
               </div>
                 <div class="col-md-6 form-group">
                    <label for="psw">Password:</label>
                    <input type="password" class="form-control" name="psw" id="psw" placeholder="Creat your password" required>
                </div>
                 <div class="col-md-6 form-group">
                    <label for="psw">Confirm password:</label>
                    <input type="password"  class="form-control" name="psw1" id="psw1" placeholder="Enter your password again" required>
                </div>
