        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="active" href="addteacher.php">Trainers</a></li>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <div class="form-conatiner">
                                <form action="kkkk.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label for="lastname">desciption:</label>
                                        <input type="text" class="form-control" name="desciption" id="desciption" placeholder="desciption" required>
                                    </div>
