        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                ...
                <li><a href="admin.php">Home</a></li>
                    ...
                    <li><a class="active" href="addworkshops.php">Workshops</a></li>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <div class="form-conatiner">
                                <form action="workshopaction.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="row" data-aos="zoom-in" data-aos-delay="100">
                                    ...
                                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                                        <div class="course-item">
                                            <div class="form-conatiner">
                                                <form enctype="multipart/form-data" method="post" action="addvideow.php">
...
<h1> Add Video</h1>
                                                    ...
                                                    <div class="custom-select" style="width:200px;">
                                                        <label for="course">workshops :</label>
                                                        <select name="workshops" required>

                                                            <option value="0">Select workshops:</option>
                                                            <?php
                                                            session_start();
                                                            require('config.php');
