...
<?php } ?> 
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <br><h1>Creativity,<br>In touch with tomorrow</h1>
              ...
              <div class="row">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Flexible Learning Experience</h4>
                    <p>We offer a flexible learning experience that allows students to tailor their education according to their preferences</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-3 col-md-4">
            <div class="icon-box">
              <i><img src="img/languages.png" class="courseIcons"></i>
              <h3><a>Languages</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              <i><img src="img/robotic-hand.png" class="courseIcons"></i>
              <h3><a>Tech</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              <i><img src="img/brand-identity.png" class="courseIcons"></i>
              <h3><a>Branding</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <i><img src="img/social-media (1).png" class="courseIcons"></i>
              <h3><a>Social Media</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i><img src="img/growth.png" class="courseIcons"></i>
              <h3><a>Business</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i><img src="img/photo.png" class="courseIcons"></i>
              <h3><a>Photography</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i><img src="img/male.png" class="courseIcons"></i>
              <h3><a>Videography</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i><img src="img/social-media (2).png" class="courseIcons"></i>
              <h3><a>Media</a></h3>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <h3><a href="course-details.php">Web Development</a></h3>
                <p>Unlock the World of Web Development: Learn, Code, and Create!</p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <p>Master the Art of SEO: Elevate Your Website's Visibility and Reach!</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <p>Master the Art of Copywriting for Compelling Content!</p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-2.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Ranin Kesrwani</h4>
                <span>Copywriter</span>
                <p>
                  Your Copywriting Maestro!
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-content">
                ...
                <p>
                  Your Digital Marketing Maverick!
                </p>
              </div>
            </div>
          </div>
